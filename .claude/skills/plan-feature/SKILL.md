...
| **Broad, multi-release / multi-Epic effort**                                   | An **Initiative** — in the repo itself when single-repo, or the outcome-owning org's `.github` when cross-repo — with **one Epic per release/capability** under it (Task sub-issues under each Epic), all grouped by **one** goal-named milestone. |
...
| Action                             | Command                                                                                                                                                                           |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Create an Initiative (umbrella)    | `gh issue create --repo <org>/.github --type Initiative --assignee "@me" --project "Tasks" --milestone "<goal-name>" --title "..." --body-file <file>` — set Status → **Tracking**                                                                        |
